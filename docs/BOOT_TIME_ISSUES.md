...
Analysis of cold boot via `ecp-boot.service` on fresh tenant provision.
...
**File:** `cluster-setup/13-install-ebs-csi.sh`  
**Commit:** `6de0235`
...
**Files:** `ami-builder/scripts/install.sh`, `cluster-setup/07-install-eks-d.sh`  
**Commit:** `81ed425`
...
**File:** `cluster-setup/08-install-cni.sh`  
**Commit:** `c66fa60`
